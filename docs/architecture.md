# Architecture — DK-DE Liste Décès · Microsoft Fabric
...
Ce projet implémente une **architecture Medallion** (Bronze / Silver / Gold) sur Microsoft Fabric. Chaque couche a une responsabilité unique et produit des données consommables par la couche suivante via Delta Lake sur OneLake.
